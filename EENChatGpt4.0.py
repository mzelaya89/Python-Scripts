...
# Create a larger text input box (multiline)
entry = tk.Text(window, width=400, height=8)  # Adjusted width and height
entry.pack()
...
# Create a larger text area for responses
response_area = scrolledtext.ScrolledText(window, width=400, height=80)  # Adjusted width and height
response_area.pack()
